...
public class TapHandlerpokemon : MonoBehaviour
{
    ...
    private DefaultTrackableEventHandler dtehpok;


    #region PRIVATE_METHODS
    private void HandleTap()
    {
        dtehpok = GetComponent<DefaultTrackableEventHandler>();
        if (mTapCount == 1)
        {
